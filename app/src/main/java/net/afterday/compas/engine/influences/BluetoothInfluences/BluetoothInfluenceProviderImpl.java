...
public class BluetoothInfluenceProviderImpl implements BluetoothInfluenceProvider {
    ...
    public BluetoothInfluenceProviderImpl(Bluetooth bluetooth, InfluencesPersistency ip) {
        ...
        providerRunning = providerState.switchMap((s) -> Objects.equals(s, RUNNING) ? Observable.interval(EMITTING_INTERVAL, TimeUnit.MILLISECONDS) : Observable.empty());
        providerState.filter((ps) -> Objects.equals(ps, RUNNING))
        ...
        android.util.Log.d(TAG, "blScans: " + blScans);
