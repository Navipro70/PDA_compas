    ...
    enum STATE {
        ...
        public long getWaitTime()
        {
            switch (this)
            {
                ...
                case W_MENTALLED: return MIN1; //Мутация
                case W_CONTROLLED: return MIN1; // Мутация
                case W_DEAD_BURER: return MIN30; //Агония
                case W_DEAD_RADIATION: return MIN30; // Агония
                case W_DEAD_ANOMALY: return MIN30; // Агония
                case W_ABDUCTED: return MIN30; // Агония
